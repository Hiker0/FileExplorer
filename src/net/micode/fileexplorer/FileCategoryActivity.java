...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dialog = new UsageDialog(mActivity, R.style.MyDialog);
        refreshCategoryInfo();
        return mRootView;
    }
    ...
    private void showPage(ViewPage p) {
        ...
        switch (p) {
            ...
            case Favorite:
                ...
                showView(R.id.path_pane_up_level, true);
                break;
            case Category:
                showView(R.id.navigation_bar, true);
                showView(R.id.file_path_list, true);
                showEmptyView(mAdapter.getCount() == 0);                
                showView(R.id.path_pane_up_level, false);
                break;
            case NoSD:
    ...
    private void setupCustomClick() {
        View button = mRootView.findViewById(R.id.button_apk);
        button.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				onCategorySelected(FileCategory.Apk);	
			}
		});
        
        View button1 = mRootView.findViewById(R.id.button_storage);
        button1.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				((FileExplorerTabActivity)mActivity).selectPage(FileExplorerTabActivity.PAGE_FILE);
			}
		});
    ...
    private static final int MENU_HOME = 19;
    private void addMenuHomeShowAlways(Menu menu) {
        MenuItem item = menu.add(0, MENU_HOME, 1, R.string.menu_home);
        item.setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        item.setIcon(R.drawable.myfiles_tab_home);
    }
    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
    	Log.d(LOG_TAG,"curViewPage="+ curViewPage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        // TODO Auto-generated method stub
    	if(item.getItemId() == R.id.action_usage){
    		 //refreshCategoryInfo();
    		dialog.show();
            return true;
        }
    ...
    public class UsageDialog extends Dialog {
        ...
        public UsageDialog(Context context, int theme){
            super(context, theme);
            this.context = context;
        }
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            this.setContentView(R.layout.usage_dialog);
            
            root = this.findViewById(R.id.dialog_root);
            setupCategoryInfo();
            refreshCategoryInfo();
            this.findViewById(R.id.button_ok).setOnClickListener(new View.OnClickListener() {
        ...
        private void setupCategoryInfo() {
            ...
            mCategoryBar = (CategoryBar) root.findViewById(R.id.category_bar);
            int[] imgs = new int[] {
                    R.drawable.storage_usage_bar_block_music, 
                    R.drawable.storage_usage_bar_block_videos,
                    R.drawable.storage_usage_bar_block_images, 
                    R.drawable.category_bar_theme,
                    R.drawable.storage_usage_bar_block_documents, 
                    R.drawable.category_bar_zip,
                    R.drawable.category_bar_apk, 
                    R.drawable.storage_usage_bar_block_others
            };
        ...
        private void setTextView(int id, String t) {
            TextView text = (TextView) root.findViewById(id);
            text.setText(t);
        }
        ...
        private void setCategorySize(FileCategory fc, long size) {
            ...
            if (txtId == 0 || resId == 0)
                return;
            setTextView(txtId, getString(resId));
        ...
        public void refreshCategoryInfo() {
            ...
            if (sdCardInfo != null) {
                ...
                setTextView(R.id.sd_card_capacity, getString(R.string.sd_card_usage, Util.convertStorage(sdCardInfo.total),Util.convertStorage(sdCardInfo.free)));
	...
	public void backHome() {
		// TODO Auto-generated method stub
		 showPage(ViewPage.Home);
		//((FileExplorerTabActivity)mActivity).selectPage(FileExplorerTabActivity.PAGE_HOME);
	}
}
