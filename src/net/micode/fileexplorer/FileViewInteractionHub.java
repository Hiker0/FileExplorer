...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    public void onOperationHome() {

    	mFileViewListener.backHome();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // menuItemClick);
//        addMenuItemShowAlways(menu, MENU_HOME, 0, R.string.menu_home,
//                R.drawable.myfiles_tab_home);
    ...
    private void addMenuItemShowAlways(Menu menu, int itemId, int order, int string, int iconRes) {
